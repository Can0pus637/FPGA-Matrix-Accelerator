...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/FIP/FIP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIP_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIP_top.tcl
