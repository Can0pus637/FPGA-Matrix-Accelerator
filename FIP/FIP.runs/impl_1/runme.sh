...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/FIP/FIP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIP_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIP_top.tcl -notrace
