...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/Baseline/Baseline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Base_top.tcl -notrace
